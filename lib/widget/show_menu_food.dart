...
class _ShowMenuFoodState extends State<ShowMenuFood> {
  ...
  Future<Null> readFoodMenu() async {
    idShop = userModel.id;
    String url =
        '${MyConstant().domain}/Project/stoerrmutl/API/getFoodWhereidshop.php?isAdd=true&id_store=$idShop';
  ...
  Future<Null> addOrderToCart(int index) async {
    String nameShop = userModel.nameStore;
    ...
    print(
        'idShop = $idShop nameShop = $nameShop idFood = $idFood nameFood =$nameFood price = $price amonut = $amount sum = $sumInt');
    Map<String, dynamic> map = Map();
    map['idStoer'] = idShop;
    map['nameStoer'] = nameShop;
    map['idFood'] = idFood;
    ...
    if (object.length == 0) {
      ...
      String idShopSQLite = object[0].idStoer;
      ...
      if (idShop == idShopSQLite) {
        ...
        normalDialog(context,
            'ตะกร้ามี รายการอาหารของ ร้าน ${object[0].nameStoer} กรุณา ซืือจากร้านนี่ให้ จบก่อน คะ');
      }
    }
  }
