...
class _AddInfoShopState extends State<AddInfoShop> {
  ...
  Future<Null> uploadImage() async {
    ...
    String url = '${MyConstant().domain}/Project/stoerrmutl/API/saveShop.php';
    ...
    try {
      ...
      await Dio().post(url, data: formData).then((value) {
        ...
        profile = '/Project/stoerrmutl/API/Shop$nameImage';
  ...
  Future<Null> editUserShop() async {
    ...
    String url =
        '${MyConstant().domain}/Project/stoerrmutl/API/editUserWhereId.php?isAdd=true&id=$id&name=$name&name_store=$nameShop&phone_number=$phone&email=$email&profile=$profile';
