...
class _EditInfoShopState extends State<EditInfoShop> {
  ...
  Future<Null> readCurrentInfo() async {
    ...
    String url =
        '${MyConstant().domain}/Project/stoerrmutl/API/getUserWhereID.php?isAdd=true&id=$id';
  ...
  Future<Null> editThread() async {
    ...
    String urlUpload =
        '${MyConstant().domain}/Project/stoerrmutl/API/saveShop.php';
    await Dio().post(urlUpload, data: formData).then((value) async {
      profile = '/Project/stoerrmutl/API/Shop/$nameFile';

      String id = userModel.id;
      //print('id == $id');
      String url =
          '${MyConstant().domain}/Project/stoerrmutl/API/editUserWhereId.php?isAdd=true&id=$id&name=$name&name_store=$nameStore&phone_number=$phone&email=$email&profile=$profile';
