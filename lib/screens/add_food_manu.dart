...
class _AddFoodMenuState extends State<AddFoodMenu> {
  ...
  Future<Null> uploadFoodAndInsertData() async {
    ...
    String urlUpload =
        '${MyConstant().domain}/Project/stoerrmutl/API/saveFood.php?';
    ...
    try {
      ...
      await Dio().post(urlUpload, data: formData).then((value) async {
        String urlPathImage = '/Project/stoerrmutl/API/Food/$nameFile';
        print('urlPathImage = ${MyConstant().domain}$urlPathImage');

        SharedPreferences preferences = await SharedPreferences.getInstance();
        String id_store = preferences.getString('id');
        String urlInserData =
            '${MyConstant().domain}/Project/stoerrmutl/API/addFood.php?isAdd=true&id_store=$id_store&name_manu=$nameFood&quantity=$quantity&price=$price&images=$urlPathImage';
