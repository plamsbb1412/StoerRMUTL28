...
class _SignUpState extends State<SignUp> {
  String gender, name, username, password, phone, email, chooseType;
  ...
  Future<Null> registerThread() async {
    String url =
        '${MyConstant().domain}/Project/stoerrmutl/API/addUser.php?isAdd=true&name=$name&username=$username&password=$password&phone_number=$phone&email=$email&chooseType=$chooseType';
    try {
